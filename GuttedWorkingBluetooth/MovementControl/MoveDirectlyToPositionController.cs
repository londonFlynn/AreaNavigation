namespace Capstone
{
    public class MoveDirectlyToPositionController : MovementControl
    {
        ...
        public ArcSegment Displayed
        {
            ...
            set
            {
                var newValue = value as ArcSegment;
                if (!(ArcDisplay is null))
                {
                    ArcDisplay.StopDisplaying();
                    newValue.SetPanel(ArcDisplay.panel);
                    newValue.SetScale(ArcDisplay.scale, ArcDisplay.horizontalOffset, ArcDisplay.verticalOffset);
                    newValue.listeners = ArcDisplay.listeners;
                    ArcDisplay.UnsubsribeAll();
                }
                ArcDisplay = newValue;
                ArcDisplay.StopDisplaying();
            }
